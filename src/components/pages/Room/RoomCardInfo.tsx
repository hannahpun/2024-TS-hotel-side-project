  ...
  return (
    <>
      ...
      <div className="text-black d-flex gap-3" style={{ marginTop: "40px" }}>
        ...
        >
          ...
          >
            <path
              fill="#bf9d7d"
              d="M21 10.78V8c0-1.65-1.35-3-3-3h-4c-.77 0-1.47.3-2 .78c-.53-.48-1.23-.78-2-.78H6C4.35 5 3 6.35 3 8v2.78c-.61.55-1 1.34-1 2.22v6h2v-2h16v2h2v-6c0-.88-.39-1.67-1-2.22M14 7h4c.55 0 1 .45 1 1v2h-6V8c0-.55.45-1 1-1M5 8c0-.55.45-1 1-1h4c.55 0 1 .45 1 1v2H5z"
            />
          </svg>
          <p className="fw-bolder fs-6 mt-3">
            <small>{room.bedInfo}</small>
          </p>
        </div>
        <div
          className="border rounded p-2"
      ...
      <div
        ...
        style={{ marginTop: "40px" }}
      >
        <h5 className="text-primary">NT$ {room.price}</h5>
        <div>
          <Link className="navbar-brand" to={`/room/${room._id}`}>
