...
export function RoomCarousel({ index, images }: { index: number, images: string[] }) {
    ...
    const indicators = images.map((img, i) => {
        ...
        return (<button type="button" data-bs-target={'#' + carouselId} data-bs-slide-to={i} className={className} key={i}></button>)
    })
    return (
